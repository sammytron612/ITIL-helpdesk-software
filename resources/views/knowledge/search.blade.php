<x-app-layout>
    ...
    <div x-data="search()" class="px-5">
        ...
        <div>
            <div x-show="loading" class="flex justify-center mt-5 text-2xl">
        ...
        <div x-show="hasResults" class="w-full p-5 px-8 mx-auto mt-8 border-2 border-gray-100 rounded-md shadow-md md:w-5/6">
            <div class="text-3xl text-left"><i class="mr-2 fa-sharp fa-sm fa-solid fa-list"></i>Results</div>
            <div class="mt-5">
                <template x-for="article in articles">
                    <div class="mb-5">
                        <a  class="hover:cursor-pointer" :href="article.href"><h2 class="mt-2 text-3xl text-blue-600" x-text="article.title"></h2></a>
