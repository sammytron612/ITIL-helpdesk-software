...
<div class="flex flex-col h-full overflow-auto md:flex-row">
    <div class="w-full h-full p-2 overflow-y-auto border-b md:border-r md:w-1/3 border-stone-200">
        
        <input class="w-full p-2 mt-2 mb-3 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" wire:model='searchTerm' placeholder="Search KB Articles" />
    ...
    <div class="w-full h-full p-2 md:w-2/3 ">
        @if($showing)
            {{$showing}}
        @endif
    </div>
