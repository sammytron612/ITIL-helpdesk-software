                                ...
                                <div>
                                    <div class="flex items-center">
                                        ...
                                        @if($comment->isMyComment() && $loop->first)
                                            <div x-transition.duration.500ms class="ml-3 hover:cursor-pointer" x-show="openComment && !newEditor" x-on:click.debounce.500ms="createNewEditor({{$comment->id}}); newEditor = ! newEditor"><x-svg.pen /></div>
                                        @endif
                                    </div>
                                </div>
