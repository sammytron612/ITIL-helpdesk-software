            ...
            <ul class="flex flex-col py-20 space-y-8">
                ...
                <a href="#">
                    <li :class="openNav ? 'justify-start ml-3' : 'justify-center'"
                        ...
                        <x-svg.ticket />
                        <div :class="openNav ? 'hidden md:block' : 'hidden'" class="ml-4">IT</div>
                    </li>
                </a>
                <a href="{{ route('ticket.create')}} ">
                    <li :class="openNav ? 'justify-start ml-3' : 'justify-center'"
                        class="flex p-1 ml-3 mr-2 text-white rounded-lg hover:bg-black ">
                        <x-svg.ticket />
                        <div :class="openNav ? 'hidden md:block' : 'hidden'" class="ml-4 md:mr-3">Create a ticket</div>
                    </li>
                </a>
                <a href="#">
                    <li :class="openNav ? 'justify-start ml-3' : 'justify-center'"
                ...
                <a href="#">
                    <li :class="openNav ? 'justify-start ml-3' : 'justify-center'"
                        class="flex p-1 mr-2 text-white rounded-lg hover:bg-black md:ml-3">
                        <x-svg.ticket />
                        <div :class="openNav ? 'hidden md:block' : 'hidden'" class="ml-4 md:mr-3">Wages</div>
                    </li>
                </a>
                ...
                <li :class="openNav ? 'justify-start ml-3' : 'justify-center'"
                    ...
                    <x-svg.ticket />
                    <div :class="openNav ? 'hidden md:block' : 'hidden'" class="ml-4 md:mr-3">Logout</div>
                </li>
                </a>
