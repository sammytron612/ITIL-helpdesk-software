    ...
    <div x-transition:enter="transition duration-500"
        ...
        <div class="h-auto border-l-4 border-blue-400">
            ...
            <div class="relative ml-2">
                <div class="absolute -top-1 -left-[16px] h-3 w-3 rounded-full border-2 border-green-500 bg-green-400"></div>
            ...
            @endforeach
            <div class="relative ml-2">
                    <div class="absolute  -left-[16px] h-3 w-3 rounded-full border-2 border-blue-400 bg-blue-200"></div>
            </div>
        </div>
    <div class="h-48"></div>
    </div>
