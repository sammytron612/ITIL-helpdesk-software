<div x-data="page()" x-init="initStorage()">
    ...
    <div  class="grid items-center justify-start md:justify-between gid-cols-2 md:grid-cols-3 gap-y-4 md:gap-y-0">
        <div class="order-1">@livewire('incidents.drop-down')</div>
        <div x-data="{ searchTerm: ''}" class="order-3 md:order-2" >
        ...
        <div class="order-2 ml-0 md:ml-5 md:order-4">
    ...
    <div wire:loading.remove class="w-full mt-3 overflow-x-auto">
        ...
        <div class="py-4 mt-2">
            <div class="order-3">
                <label class="font-bold" for="shown">Showing</label>
