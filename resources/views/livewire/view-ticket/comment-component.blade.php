        ...
        return {
            ...
            async selectArticle(id,title){
                ...
                try {
                    ...
                    const response = await axios.get("http://localhost:9000/api/show/" + id)
